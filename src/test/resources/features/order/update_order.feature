@order
Feature: Update a order

  Background:
    Given The user has valid credentials as "Özgür Kartal" and "ozgur15@gmail.com"
  ...
  Scenario: Update a order with valid authorization
    Given The endpoint is accessed
    When The user sends PATCH request to "/orders" with different customer name as "Özgür" valid orderId
